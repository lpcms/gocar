...
/**
 * One car page. Only a live car resolves; anything else is a 404, so a
 * draft or a mistyped slug cannot invent a page.
 */
...
export default async function CarDetailRoute({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
